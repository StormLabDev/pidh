...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="​Nous Contacter, ​Notre bureau principal,Parlement international des droits de l'homme">
    <meta name="description" content="Page contenant toutes les informations pour nous contacter">

    <title>{{ __('Contacter') }}</title>
    <link rel="stylesheet" href="{{ URL::asset('css/nicepage.css') }}" media="screen">
<link rel="stylesheet" href="{{ URL::asset('css/Contacter.css') }}" media="screen">
...
<script class="u-script" type="text/javascript" src="{{ URL::asset('js/nicepage.js') }}" defer=""></script>
  ...
  <body class="u-body u-xl-mode"><header class=" u-clearfix u-header u-section-row-container" id="sec-a62b"><div class="u-section-rows">
              ...
              <div class="u-repeater u-repeater-1">
                <div class="u-container-style u-list-item u-repeater-item">
                  <div class="u-container-layout u-similar-container u-valign-top-xs u-container-layout-1">
                    <img class="u-expanded-width-lg u-expanded-width-md u-expanded-width-sm u-expanded-width-xl u-image u-image-default u-preserve-proportions u-image-4" src="{{ URL::asset('images/197560.png') }}" alt="" data-image-width="128" data-image-height="128" data-href="{{ route('contacter','fr') }}">
                  </div>
                </div>
                <div class="u-container-style u-list-item u-repeater-item">
                  <div class="u-container-layout u-similar-container u-valign-top-xs u-container-layout-2">
                    <img class="u-expanded-width-lg u-expanded-width-md u-expanded-width-sm u-expanded-width-xl u-image u-image-default u-preserve-proportions u-image-5" src="{{ URL::asset('images/saudi-arabia-flag-round-icon-256.png') }}" alt="" data-image-width="256" data-image-height="256" data-href="{{ route('contacter','ar') }}">
                  </div>
                </div>
                <div class="u-container-style u-list-item u-repeater-item">
                  <div class="u-container-layout u-similar-container u-valign-top-xs u-container-layout-3">
                    <img class="u-expanded-width-lg u-expanded-width-md u-expanded-width-sm u-expanded-width-xl u-image u-image-default u-preserve-proportions u-image-6" src="{{ URL::asset('images/kisspng-flag-of-spain-clip-art-vector-graphics-spain-flag-png-5b875871e27dc2.7026162615355966579277.png') }}" alt="" data-image-width="512" data-image-height="512" data-href="{{ route('contacter','es') }}">
                  </div>
                </div>
                <div class="u-container-style u-list-item u-repeater-item">
                  <div class="u-container-layout u-similar-container u-valign-top-xs u-container-layout-4">
                    <img class="u-expanded-width-lg u-expanded-width-md u-expanded-width-sm u-expanded-width-xl u-image u-image-default u-preserve-proportions u-image-7" src="{{ URL::asset('images/512px-United-kingdom_flag_icon_round.svg.png') }}" alt="" data-image-width="512" data-image-height="512" data-href="{{ route('contacter','en') }}">
                  </div>
                </div>
              </div>
            </div>
    ...
    <section class="u-clearfix u-section-1" id="sec-0b87">
      <div class="u-clearfix u-sheet u-sheet-1"></div>
    </section>
    <section class="u-clearfix u-section-2" id="sec-bedb">
    ...
    <section class="u-clearfix u-section-3" id="sec-87e9">
      <div class="u-clearfix u-sheet u-sheet-1"></div>
    </section>
    <section class="u-align-center u-clearfix u-section-4" id="carousel_6da0">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-custom-font u-font-montserrat u-text u-text-palette-1-base u-text-1"> {{ __('Con1') }}</h2>
        <h4 class="u-custom-font u-font-montserrat u-text u-text-2">www.pidh.org <br>
          <br>{{ __('Con2') }}
        </h4>
      </div>
    </section>
